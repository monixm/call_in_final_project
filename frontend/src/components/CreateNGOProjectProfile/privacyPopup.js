  ...
  render() {
    return (
        ...
        <div className='privacy-popup-inner'>
            ...
            <div>
                <input className='public-radio' value='public' type="radio" id="public" name="radioA"
                ...
                <input className='private-radio' value='private' type="radio" id="private" name="radioA"
                ...
                <input className='controlled-radio' value='controlled' type="radio" id="controlled" name="radioA"
                ...
                <input className='secret-radio' value='secret' type="radio" id="secret" name="radioA"
