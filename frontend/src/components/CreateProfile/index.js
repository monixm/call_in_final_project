...
class CreateProfile extends Component {
    ...
    toggleNetworkingPopupLinkedin = () => {
        const newState = {...this.state};
        newState.showNetworkingPopupLinkedin = !this.state.showNetworkingPopupLinkedin;
        this.setState(newState);
    }
    toggleNetworkingPopupInstagram = () => {
        const newState = {...this.state};
        newState.showNetworkingPopupInstagram = !this.state.showNetworkingPopupInstagram;
        this.setState(newState);
    };
            ...
            <div className='main'>
                ...
                <div className='first_data'>
                    ...
                    <div className='first_right'>
                        <input type='text' className='input_field' placeholder=''
                               onChange={event => this.handleTextInput(event, 'email')} value={this.state.email}/>
                    </div>
                </div>
                <div className='second_data_1'>
                    ...
                    <div className='second_data_1_right'>
                        <input type='text' className='input_field' placeholder=''
                               onChange={event => this.handleTextInput(event, 'code')} value={this.state.code}/>
                    </div>
                </div>
                <div className='first_data'>
                    <div className='first_left'>
                    ...
                    <div className='first_right'>
                        <input type='text' className='input_field' placeholder=''
                               onChange={event => this.handleTextInput(event, 'name')} value={this.state.name}/>
                    </div>
                </div>
                <div className='second_data'>
                    ...
                    <div className='second_right'>
                        <input type='text' className='input_field' placeholder=''
                               onChange={event => this.handleTextInput(event, 'lastName')} value={this.state.lastName}/>
                    </div>
                </div>
                ...
                <div className='second_data_2'>
                    ...
                    <div className='second_data_2_right'>
                        <input type='password' className='input_field' placeholder=''
                               onChange={event => this.handleTextInput(event, 'password')} value={this.state.password}/>
                    </div>
                </div>
                ...
                <div className='third_data'>
                    ...
                    <div className='third_right'>
                        <input type='text' className='input_field' placeholder=''
                               onChange={event => this.handleTextInput(event, 'location')} value={this.state.location}/>
                    </div>
                </div>
                <div className='fourth_data'>
                    <div className='fourth_left'>
                        <p className='labels'>What can you offer?</p>
                        <p className='lower_font'>(your interest, skills, professional services, or items to
                            offer-please add keywords)</p>
                    </div>

                    <div className='fourth_right'>
                        <button className='button-decoration' onClick={() => this.toggleFocusPopup()}>Edit keywords
                        </button>
                    ...
                    {this.state.showFocusPopup ?
                        <VolunteerInterestsPopup
                            ...
                            changeInterest={(event, interest) => this.handleInterestInput(event, interest)}
                        /> : <div></div>}
                </div>
                ...
                <div className='fifth_data'>
                    <div className='fifth_left'>
                        ...
                        <p className='lower_font'>(We would love to meet you in person to talk about pour vision and
                            expectations for the Call In community)</p>
                    </div>
                    <div className='fifth_right'>
                        <input className='input_radio' type='radio' name='select'/>
                        {this.state.meeting === 'now' && (<p className='lower_font'>message sent!</p>)}
                    </div>
                ...
                <div className='seventh_data'>
                    ...
                    <div className='seventh_right'>
                        <button className='button-decoration' onClick={() => this.toggleNetworkingPopup()}>Facebook
                        </button>
                        <button className='button-decoration'
                                onClick={() => this.toggleNetworkingPopupInstagram()}>Instagram
                        </button>
                        <button className='button-decoration'
                                onClick={() => this.toggleNetworkingPopupLinkedin()}>LinkedIn
                        </button>
                    </div>
                ...
                <div className='eighth_data'>
                    ...
                    <div className='eighth_right'>
                        <button className='button-decoration' onClick={() => this.togglePrivacySettingsPopup()}>Privacy
                            Settings
                        </button>
                    </div>
                    {this.state.showPrivacySettingsPopup ?
                        <VolunteerPrivacySettingPopup
                            ...
                            handlePrivacyInput={(event) => this.handleTextInput(event, 'privacySettings')}
                        /> : <div></div>}
                </div>
                <div className='eighth_data'>
                    <div className='eighth_left'>
                ...
                <div className='ninth_data'>
                    <div className='ninth_middle'>
                        <button className='ninth_middle' onClick={this.handleClick}>Create Profile</button>
                    </div>
                </div>
            </div>
        )
