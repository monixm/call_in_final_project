...
class Search extends Component {
  ...
  handleInterestClick = interest => {
    ...
    newState.volunteerInterest[interest] = !this.state.volunteerInterest[
      interest
    ];
      ...
      <div>
        ...
        <div className='focus_list'>
          <div className='focus_right'>
            <button
              onClick={() => this.handleInterestClick('social')}
              className={
                this.state.volunteerInterest.social
                  ? 'button-clicked-decoration'
                  : 'button-decoration'
              }
            >
              Social
            ...
            <button
              onClick={() => this.handleInterestClick('sports')}
              className={
                this.state.volunteerInterest.sports
                  ? 'button-clicked-decoration'
                  : 'button-decoration'
              }
            >
            ...
            <button
              onClick={() => this.handleInterestClick('coaching')}
              className={
                this.state.volunteerInterest.coaching
                  ? 'button-clicked-decoration'
                  : 'button-decoration'
              }
            >
            ...
            <button
              onClick={() => this.handleInterestClick('politics')}
              className={
                this.state.volunteerInterest.politics
                  ? 'button-clicked-decoration'
                  : 'button-decoration'
              }
            >
          ...
          <div className='focus_left'>
            <button
              onClick={() => this.handleInterestClick('languages')}
              className={
                this.state.volunteerInterest.languages
                  ? 'button-clicked-decoration'
                  : 'button-decoration'
              }
            >
            ...
            <button
              onClick={() => this.handleInterestClick('arts_culture')}
              className={
                this.state.volunteerInterest.arts_culture
                  ? 'button-clicked-decoration'
                  : 'button-decoration'
              }
            >
            ...
            <button
              onClick={() => this.handleInterestClick('food')}
              className={
                this.state.volunteerInterest.food
                  ? 'button-clicked-decoration'
                  : 'button-decoration'
              }
            >
            ...
            <button
              onClick={() => this.handleInterestClick('items')}
              className={
                this.state.volunteerInterest.items
                  ? 'button-clicked-decoration'
                  : 'button-decoration'
              }
            >
